...
$processor_email = [    
"Delivery of Learners Licence" => [
"subject" => "Your Learners Licence Appointment - Acknowledgement Attached",
"message" => 
"Dear  Sir / Ma'am,
<br><br>
Congratulations!!<br>
Your Learners Licence (DL) Application has been done and acknowledgment for the same has been attached herewith. Following Attachments are being sent for your perusal.<br><br>

1. Copy of Duly filled Application Form,<br>
2. Driving Licence Acknowledgement Slip,<br>
3. Form 1,<br>
4. Form 1A,<br>
5. Appointment Slip.<br>
<br>
...
<br>
Date Slot: <span class='date-slot-box' style='font-weight: 700; text-transform: uppercase'>______________________</span>.
<br><br>
To book date slot as per your convenience, click here
<br>
<a href='https://sarathi.parivahan.gov.in/sarathiservice/stateSelection.do' style='color: #ffffff;'>https://sarathi.parivahan.gov.in/sarathiservice/stateSelection.do</a>
<br><br>
