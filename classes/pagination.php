    ...
    if (document.querySelector('.pagination-box') !== null) {
        ...
        pageNumberBox.forEach(element => {
            if (urlSearchParams.get('text') !== null) {
                if (urlSearchParams.get('stage') !== null) {
                    var href = '<?php echo $_SERVER["PHP_SELF"]; ?>?page='+element+'&business=<?php echo $_GET["business"]; ?>&website=<?php echo $_GET["website"]; ?>&status=<?php echo $_GET["status"]; ?>&payVendor=<?php echo $_GET["payVendor"]; ?>&amount=<?php echo $_GET["amount"]; ?>&sales=<?php echo $_GET["sales"]; ?>&processor=<?php echo $_GET["processor"]; ?>&fromDate=<?php echo $_GET["fromDate"]; ?>&toDate=<?php echo $_GET["toDate"]; ?>&orderBy=<?php echo $_GET["orderBy"]; ?>&text='+urlSearchParams.get('text')+'&display=on&stage='+urlSearchParams.get('stage');
                } else {
                    var href = '<?php echo $_SERVER["PHP_SELF"]; ?>?page='+element+'&business=<?php echo $_GET["business"]; ?>&website=<?php echo $_GET["website"]; ?>&status=<?php echo $_GET["status"]; ?>&payVendor=<?php echo $_GET["payVendor"]; ?>&amount=<?php echo $_GET["amount"]; ?>&sales=<?php echo $_GET["sales"]; ?>&processor=<?php echo $_GET["processor"]; ?>&fromDate=<?php echo $_GET["fromDate"]; ?>&toDate=<?php echo $_GET["toDate"]; ?>&orderBy=<?php echo $_GET["orderBy"]; ?>&text='+urlSearchParams.get('text')+'&display=on';
                }
            } else {
                if (urlSearchParams.get('stage') !== null) {
                    var href = '<?php echo $_SERVER["PHP_SELF"]; ?>?page='+element+'&business=<?php echo $_GET["business"]; ?>&website=<?php echo $_GET["website"]; ?>&status=<?php echo $_GET["status"]; ?>&payVendor=<?php echo $_GET["payVendor"]; ?>&amount=<?php echo $_GET["amount"]; ?>&sales=<?php echo $_GET["sales"]; ?>&processor=<?php echo $_GET["processor"]; ?>&fromDate=<?php echo $_GET["fromDate"]; ?>&toDate=<?php echo $_GET["toDate"]; ?>&orderBy=<?php echo $_GET["orderBy"]; ?>&display=on&stage='+urlSearchParams.get('stage');
                } else {
                    var href = '<?php echo $_SERVER["PHP_SELF"]; ?>?page='+element+'&business=<?php echo $_GET["business"]; ?>&website=<?php echo $_GET["website"]; ?>&status=<?php echo $_GET["status"]; ?>&payVendor=<?php echo $_GET["payVendor"]; ?>&amount=<?php echo $_GET["amount"]; ?>&sales=<?php echo $_GET["sales"]; ?>&processor=<?php echo $_GET["processor"]; ?>&fromDate=<?php echo $_GET["fromDate"]; ?>&toDate=<?php echo $_GET["toDate"]; ?>&orderBy=<?php echo $_GET["orderBy"]; ?>';
                }
            }
