    ...
    if (document.querySelector('.pagination-box') !== null) {
        ...
        pageNumberBox.forEach(element => {
            if (urlSearchParams.get('text') !== null) {
                var href = '<?php echo $_SERVER["PHP_SELF"]; ?>?page='+element+'&website=<?php echo $_GET["website"]; ?>&status=<?php echo $_GET["status"]; ?>&fromDate=<?php echo $_GET["fromDate"]; ?>&toDate=<?php echo $_GET["toDate"]; ?>&orderBy=<?php echo $_GET["orderBy"]; ?>&text='+urlSearchParams.get('text')+'';
            } else {
                var href = '<?php echo $_SERVER["PHP_SELF"]; ?>?page='+element+'&website=<?php echo $_GET["website"]; ?>&status=<?php echo $_GET["status"]; ?>&fromDate=<?php echo $_GET["fromDate"]; ?>&toDate=<?php echo $_GET["toDate"]; ?>&orderBy=<?php echo $_GET["orderBy"]; ?>';
            }
