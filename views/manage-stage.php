...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/manage-stage.css">
...
<body>
    ...
    <?php
    include_once('../components/manage-stage.php');
    ?>
    ...
    <script src="../assets/js/manage-stage.js"></script>
</body>
</html>