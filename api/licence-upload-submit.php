...
$sql_update_form = 'UPDATE forms SET stage = "Pending", delivered_on = "", is_assigned = "", is_follow_up = "", is_comment = "" WHERE id = "'.$form_id.'"';
...
if ($result_update_form) {
    ...
    $new_remarks = 'Automated marked back to Pending as client has uploaded document successfully.';
